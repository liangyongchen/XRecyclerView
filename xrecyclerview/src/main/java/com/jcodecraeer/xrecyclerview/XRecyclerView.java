...
public class XRecyclerView extends RecyclerView {
    ...
    private LoadingListener mLoadingListener;  // 页脚加载更多
    private ArrowRefreshHeader mRefreshHeader; // 头部刷新
    private boolean pullRefreshEnabled = true; // 上拉刷新默认启动
    private boolean loadingMoreEnabled = true; // 加载更多默认启动
